...
static int retekess_ook_prepare(uint8_t *raw, retekess_ook_t *payload) {
    int pos = 0;
...
int retekess_ook_pager(SX1276 fsk, int tx_power, float tx_frequency,
    ...
    int len = retekess_ook_prepare(tx.buffer, &p);
